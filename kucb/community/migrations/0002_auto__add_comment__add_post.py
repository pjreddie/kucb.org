...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('community_comment', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['community.Post'])),
        ))
        db.send_create_signal('community', ['Comment'])

        # Adding model 'Post'
        db.create_table('community_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='posts', null=True, on_delete=models.SET_NULL, to=orm['about.Bio'])),
            ...
            ('big_image', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('community_comment')
