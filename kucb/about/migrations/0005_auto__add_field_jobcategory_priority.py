...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCategory.priority'
        db.add_column('about_jobcategory', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCategory.priority'
        db.delete_column('about_jobcategory', 'priority')
