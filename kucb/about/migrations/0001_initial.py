...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('about', ['Content'])

        # Adding model 'Bio'
        db.create_table('about_bio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bio', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.send_create_signal('about', ['Bio'])

        # Adding model 'Announcement'
        db.create_table('about_announcement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('text', self.gf('tinymce.models.HTMLField')()),
        ...
        db.send_create_signal('about', ['Announcement'])

        # Adding model 'Program'
        db.create_table('about_program', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=500)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('producer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['about.Bio'], null=True, blank=True)),
        ...
        db.send_create_signal('about', ['Program'])

        # Adding model 'Schedule'
        db.create_table('about_schedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule', to=orm['about.Program'])),
            ('day', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('start_time', self.gf('django.db.models.fields.TimeField')()),
            ('end_time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('about', ['Schedule'])


    def backwards(self, orm):
        # Deleting model 'Content'
        db.delete_table('about_content')

        # Deleting model 'Bio'
        db.delete_table('about_bio')

        # Deleting model 'Announcement'
        db.delete_table('about_announcement')

        # Deleting model 'Program'
        db.delete_table('about_program')

        # Deleting model 'Schedule'
        db.delete_table('about_schedule')
    ...
    models = {
        ...
        'about.program': {
            ...
            'producer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['about.Bio']", 'null': 'True', 'blank': 'True'}),
        ...
        'about.schedule': {
            ...
            'day': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schedule'", 'to': "orm['about.Program']"}),
