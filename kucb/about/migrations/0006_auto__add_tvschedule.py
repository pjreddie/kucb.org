...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TVSchedule'
        db.create_table('about_tvschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tv-schedule', to=orm['about.Program'])),
            ('day', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('start_time', self.gf('django.db.models.fields.TimeField')()),
            ('end_time', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('about', ['TVSchedule'])


    def backwards(self, orm):
        # Deleting model 'TVSchedule'
        db.delete_table('about_tvschedule')
    ...
    models = {
        ...
        'about.tvschedule': {
            'Meta': {'object_name': 'TVSchedule'},
            'day': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            'end_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tv-schedule'", 'to': "orm['about.Program']"}),
            'start_time': ('django.db.models.fields.TimeField', [], {})
        },
        'auth.group': {
